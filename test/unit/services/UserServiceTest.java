...
public class UserServiceTest {
    ...
    public void sendChatRequest() throws InstantiationException, IllegalAccessException {
        ...
        when(privateRoomDao.findByActiveRoomMembers(anyLong(), anyLong())).thenReturn(Optional.empty());
    ...
    public void sendChatRequestRoomAlreadyExists() {
        ...
        when(privateRoomDao.findByActiveRoomMembers(anyLong(), anyLong())).thenReturn(Optional.of(new PrivateRoom()));
    ...
    public void sendSingleAndroidNotification() throws Throwable {
        ...
        List<Device> devices = deviceFactory.createList(1, FieldOverride.of("platform", Device.Platform.android));
        when(userDao.getDevices(mockReceiver)).thenReturn(devices);
    ...
    public void sendSingleIosNotification() throws Throwable {
        ...
        List<Device> devices = deviceFactory.createList(1, FieldOverride.of("platform", Device.Platform.ios));
        when(userDao.getDevices(mockReceiver)).thenReturn(devices);
